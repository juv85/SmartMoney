...
class GemmaBridgeModule(private val reactContext: ReactApplicationContext) :
        ReactContextBaseJavaModule(reactContext) {

    private var llmInference: LlmInference? = null
    private val backgroundExecutor = Executors.newSingleThreadExecutor()

    override fun getName() = "GemmaBridgeModule"

    // MARK: - Core Model Operations

    @ReactMethod
    fun modelHello(promise: Promise) {
        promise.resolve("Gemma says hello from Kotlin !")
    }
        ...
        backgroundExecutor.execute {
            try {
                ...
                val actualPath =
                        when {
                            ...
                            filePath.startsWith("file://") -> filePath.substring(7)
                                ...
                                val internalPath =
                                        File(reactContext.filesDir, filePath).absolutePath
                ...
                if (useGPU && isGPUSupported()) {
                    ...
                    // baseOptionsBuilder.setDelegate("GPU")
        ...
        return try {
            android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N &&
                    reactContext.packageManager.hasSystemFeature(
                            android.content.pm.PackageManager.FEATURE_VULKAN_HARDWARE_COMPUTE
                    ) &&
    ...
    private fun getTotalMemoryMB(): Int {
        val activityManager =
                reactContext.getSystemService(android.content.Context.ACTIVITY_SERVICE) as
